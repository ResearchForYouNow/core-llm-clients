...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            artifactId = "llm-provider-gemini"
            artifact(javadocJar)

            pom {
                name.set("LLM Clients - Gemini Provider")
                description.set("Gemini provider implementation for the ResearchForYouNow LLM client stack.")
